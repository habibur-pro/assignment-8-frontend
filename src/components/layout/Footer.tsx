...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full bg-primary text-white pt-8 ">
      <div className="w-full px-8 mx-auto max-w-7xl">
        <div className="grid justify-between grid-cols-1 gap-4 md:grid-cols-2">
          <div>
            <h3 className="block mb-6 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-inherit">
              {" "}
              Luxe Fashion
            </h3>
            ...
            <ul>
              ...
              {navLinks.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="block py-1.5 font-sans text-base font-normal leading-relaxed opacity-50 antialiased transition-colors hover:text-blue-gray-900"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="flex flex-col items-center justify-center w-full py-4 mt-12 border-t border-blue-gray-50 md:flex-row md:justify-center">
          <p className="block mb-4 font-sans text-sm antialiased font-normal leading-normal text-center text-blue-gray-900 md:mb-0 ">
            Copyright © 2024 Renew Habibur Rahman
          </p>
        </div>
      </div>
    </footer>
